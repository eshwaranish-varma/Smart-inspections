...
export default function ObservationCard({
  ...
  const pct = Math.round(observation.confidence_score * 100);
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
      ...
      <span className="mb-3 inline-block rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-800">
      ...
      <div className="mb-3 h-2 w-full overflow-hidden rounded-full bg-gray-100">
        <div
          className={`h-full rounded-full transition-all ${confidenceColor(observation.confidence_score)}`}
          style={{ width: `${pct}%` }}
        />
      </div>
