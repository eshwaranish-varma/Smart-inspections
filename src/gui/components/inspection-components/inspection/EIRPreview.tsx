    ...
    <div className="mx-auto space-y-6">
      <div className="mx-auto w-[8.5in] min-h-[11in] bg-white px-[0.7in] py-[0.8in] shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
        ...
        <div className="mt-6 space-y-2 text-sm text-gray-700">
          <p>
            <span className="font-semibold">Firm:</span> {metadata.firm_name}
          </p>
          <p>
            <span className="font-semibold">FEI:</span> {metadata.fei_number}
          </p>
          <p>
            <span className="font-semibold">District Office:</span> {metadata.district_office}
          </p>
          <p>
            <span className="font-semibold">Inspection Dates:</span> {metadata.inspection_start} to {metadata.inspection_end}
          </p>
        </div>
