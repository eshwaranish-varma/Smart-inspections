    ...
    try {
      ...
      setMetadata(prev => {
        ...
        return {
          ...
          fei_number: String(parsed.fei_number || prev.fei_number).replace(/\D+/g, '').slice(0, 7),
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-navy-500 focus:ring-1 focus:ring-navy-500 outline-none"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e => updateMeta('fei_number', e.target.value)}
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-navy-500 focus:ring-1 focus:ring-navy-500 outline-none bg-white"
                >
              ...
              {metadata.investigators.map((inv, i) => (
                <div key={i} className="flex gap-3 mb-2">
                  <input
                    ...
                    className="flex-1 rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-navy-500 focus:ring-1 focus:ring-navy-500 outline-none"
                  />
                  <input
                    type="text"
                    placeholder="Title"
                              ...
                              {uf.ocrResult && (
                                <div className="mt-4 space-y-3">
                                  ...
                                  <textarea
                                    ...
                                    rows={6}
                                    className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm font-mono focus:border-navy-500 focus:ring-1 focus:ring-navy-500 outline-none"
                                  />
                                </div>
                              )}
                            </div>
                ...
                {notesTab === 'type' && (
                  <div>
                    <textarea
                      ...
                      className="w-full min-h-[300px] rounded-md border border-gray-300 px-4 py-3 text-sm focus:border-navy-500 focus:ring-1 focus:ring-navy-500 outline-none resize-y"
                    />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              rows={2}
                              className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-navy-500 focus:ring-1 focus:ring-navy-500 outline-none bg-white resize-y"
                            />
                          </div>
                          <div>
                            <label className="block text-xs font-medium text-gray-600 mb-1">
                ...
                <div className="p-5 space-y-4">
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full rounded-md border border-gray-300 px-3 py-2 text-sm focus:border-navy-500 focus:ring-1 focus:ring-navy-500 outline-none resize-y"
                    />
                  </div>
